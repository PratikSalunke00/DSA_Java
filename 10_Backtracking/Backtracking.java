...
//N-Queens problem using backtracking with counting the total number of solutions
// public class Backtracking{
//     public static boolean isSafe(char board[][], int row, int col) {
//         //vertical up
//         for(int i = row-1 ; i >= 0 ; i--) {
...
//N-Queens problem using backtracking with counting the total number of solutions and printing only one solution
// public class Backtracking{
//     public static boolean isSafe(char board[][], int row, int col) {
//         //vertical up
//         for(int i = row-1 ; i >= 0 ; i--) {
...
//Grid Ways problem using backtracking
public class Backtracking{
    ...
    public static void main(String args[]) {
       int n = 3 , m = 3;
       System.out.println("Total ways to reach the destination: " + gridWays(0, 0, n, m));
    }
}
